    ...
    <div class="container">
        <div class="row">
            <div>
                ...
                <p style ="margin-left: 20px;">Tên: VU TUAN LINH<br>
                    Ngân hàng: Viettinbank chi nhánh XXX<br>
                    Số tài khoản: 100873047478</p>
                <strong>2.Ví điện tử MOMO: </strong>
                <p style ="margin-left: 20px;">Tên: VU TUAN LINH<br>
                    Số điện thoại: 0399902314</p>
                <strong>3.Ví điện tử ZaloPay: </strong>
                <p style ="margin-left: 20px;">Tên: VU TUAN LINH<br>
                    Số điện thoại: 0399902314</p>
                <i>Sau khi thanh toán, nếu gặp bất kì sự cố nào vui lòng liên hệ tới số Hotline 0399902314</i><br><br>
            </div>
        </div>
    </div>
</section>
