                            ...
                            <div class="col-md-7 col-sm-7 col-xs-12">
                                <div class="aa-product-view-content">
                                    ...
                                    <div class="aa-prod-view-bottom">
                                        <a class="aa-add-to-cart-btn" href="${pageContext.request.contextPath}/client/addtocart?product-id=${detail_product.id}">Thêm vào giỏ hàng</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade " id="review">
                                <div class="aa-product-review-area">
                                    ...
                                    <h4>Thêm đánh giá</h4>
                                    <!-- review form -->
                                    <form action="${pageContext.request.contextPath}/client/review?id=${detail_product.id}" method="post" class="aa-review-form">
                            ...
                            <c:forEach items="${productById}" var="product">
                                <li>
                                    <figure>
                                        ...
                                        <figcaption>
                                            <h4 class="aa-product-title"><a href="${pageContext.request.contextPath}/product/details?id?id=${product.id}">${product.name}</a></h4>
                                                <c:choose>
...
<script src="https://cdn.tiny.cloud/1/<kl7reqa0qdgaxequuz52z24x7w53izbozufdy5c61d8vb57c>/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
