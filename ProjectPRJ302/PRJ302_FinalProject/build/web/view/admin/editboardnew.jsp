            ...
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-body">
                        ...
                        <hr>
                        <form action="${pageContext.request.contextPath}/admin/boardnew/update" method="post">
...
<!--                                <button class="btn btn-success" > <a href="${pageContext.request.contextPath}/admin/product/list"> Cập nhật</button>-->
                                <button class="btn btn-success"><a href="${pageContext.request.contextPath}/admin/product/list">Cập Nhật</a></button>
                            </div>
                        </form>
                    </div>
                </div>
