            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <hr>
                        <form action="${pageContext.request.contextPath}/admin/boardnew/add" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    <select class="form-control valid" id="input-4" name="new-author" required aria-invalid="false">
                                        <option>Vu Tuan Linh 1</option>
                                        <option>Vu Tuan Linh 2</option>
                                        <option>Vu Tuan Linh 3</option>
                                        <option>Vu Tuan Linh 4</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-footer">
                                ...
                                <button class="btn btn-danger"><i class="fa fa-times"></i><a href="${pageContext.request.contextPath}/admin/boardnew/list">Hủy</a></button>
